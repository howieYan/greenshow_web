...
var $pointer = $api.byId('pointer0');
this.mySlide = Swipe(slide, {
    continuous: true,
    disableScroll: true,
    stopPropagation: true,
    callback: function (index, element) {
        var $actA = $api.dom($pointer, 'a.active1');
        $api.removeCls($actA, 'active1');
        $api.addCls($api.eq($pointer, index + 1), 'active1');
    },
